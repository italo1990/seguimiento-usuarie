...
{{-- @push('head')
<script src="{{ asset('js/module/usuaries/tabs.js')}}"></script>
<link href="{{ asset('css/module/usuaries/tabs.css') }}" rel="stylesheet">
@endpush --}}
...
@push('custom-scripts')
    <script type="text/javascript" src="{{ URL::asset ('js/module/usuaries/tab.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset ('js/module/usuaries/create-user.js') }}"></script>
@endpush

<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.usuary.title_singular') }}
    </div>

    <div class="card-body">
        <div class="tab">
            <button class="tablinks" onclick="openOption(event, 'identifiers')" id="defaultOpen">Identificativos</button>
            <button class="tablinks" onclick="openOption(event, 'socioeconomic')">Socioeconímicos</button>
            <button class="tablinks" onclick="openOption(event, 'sanitary')">Sanitarios</button>
            <button class="tablinks" onclick="openOption(event, 'supportNetwork')">Red de apoyo</button>
            <button class="tablinks" onclick="openOption(event, 'Housing')">Vivienda</button>
            <button class="tablinks" onclick="openOption(event, 'suicidalBehaviorRisk')">Riesgo de conducta suicida</button>
            <button class="tablinks" onclick="openOption(event, 'genderViolence')">Violencia de género</button>
            <button class="tablinks" onclick="openOption(event, 'alta')">Alta</button>
            <button class="tablinks" onclick="openOption(event, 'document')">Documentos</button>
          </div>
        <form method="POST" action="{{ route("admin.usuaries.store") }}" enctype="multipart/form-data">
            @csrf

            <div id="identifiers" class="tabcontent">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::DOCUMENTACION_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('documentacion') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="other_documentation_toggle(event)" type="radio" id="documentacion_{{ $key }}" name="documentacion" value="{{ $key }}" {{ old('documentacion', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="otro_documentacion_toggle">
                    <label for="otro_documentacion">{{ trans('cruds.usuary.fields.otro_documentacion') }}</label>
                    <input class="form-control {{ $errors->has('otro_documentacion') ? 'is-invalid' : '' }}" type="text" name="otro_documentacion" id="otro_documentacion" value="{{ old('otro_documentacion', '') }}">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::GENERO_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('genero') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="other_gender_toggle(event)" type="radio" id="genero_{{ $key }}" name="genero" value="{{ $key }}" {{ old('genero', '') === (string) $key ? 'checked' : '' }} required>
                ...
                <div class="form-group" id="otro_genero_toggle">
                    <label for="otro_genero">{{ trans('cruds.usuary.fields.otro_genero') }}</label>
                    <input class="form-control {{ $errors->has('otro_genero') ? 'is-invalid' : '' }}" type="text" name="otro_genero" id="otro_genero" value="{{ old('otro_genero', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('lugar_residencia') ? 'is-invalid' : '' }}" name="lugar_residencia" id="lugar_residencia" required>
                        ...
                        @foreach(App\Models\Usuary::LUGAR_RESIDENCIA_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('lugar_residencia', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('area_asignada') ? 'is-invalid' : '' }}" name="area_asignada[]" id="area_asignada" required multiple>
                        ...
                        {{-- @foreach(App\Models\Usuary::AREA_ASIGNADA_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('area_asignada', '[]') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach --}}
                        {{-- @foreach(App\Models\Usuary::AREA_ASIGNADA_SELECT as $id => $area_asignada)
                            <option value="{{ $id }}" {{ in_array($id, old('area_asignada', [])) ? 'selected' : '' }}>{{ $area_asignada }}</option>
                        @endforeach --}}
                ...
                {{-- <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('psicologa_asignadas') ? 'is-invalid' : '' }}" name="psicologa_asignadas[]" id="psicologa_asignadas" multiple required>
                        @foreach($psicologa_asignadas as $id => $psicologa_asignada)
                            <option value="{{ $id }}" {{ in_array($id, old('psicologa_asignadas', [])) ? 'selected' : '' }}>{{ $psicologa_asignada }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('motivo_consulta') ? 'is-invalid' : '' }}" name="motivo_consulta" id="motivo_consulta">{!! old('motivo_consulta') !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('fecha_registro') ? 'is-invalid' : '' }}" type="text" name="fecha_registro" id="fecha_registro" value="{{ old('fecha_registro') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nacionalidad') ? 'is-invalid' : '' }}" type="text" name="nacionalidad" id="nacionalidad" value="{{ old('nacionalidad', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('direccion_domicilio') ? 'is-invalid' : '' }}" type="text" name="direccion_domicilio" id="direccion_domicilio" value="{{ old('direccion_domicilio', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('provincia_residencia') ? 'is-invalid' : '' }}" name="provincia_residencia" id="provincia_residencia">
                        ...
                        @foreach(App\Models\Usuary::PROVINCIA_RESIDENCIA_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('provincia_residencia', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::ES_DE_LA_FUENSANTA_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('es_de_la_fuensanta') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="es_de_la_fuensanta_{{ $key }}" name="es_de_la_fuensanta" value="{{ $key }}" {{ old('es_de_la_fuensanta', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::PERMISO_RESIDENCIA_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('permiso_residencia') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="permiso_residencia_{{ $key }}" name="permiso_residencia" value="{{ $key }}" {{ old('permiso_residencia', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('permiso_trabajo') ? 'is-invalid' : '' }}" name="permiso_trabajo" id="permiso_trabajo">
                        ...
                        @foreach(App\Models\Usuary::PERMISO_TRABAJO_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('permiso_trabajo', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('como_nos_conocio') ? 'is-invalid' : '' }}" onchange="how_you_met_us_toggle(event)" name="como_nos_conocio" id="como_nos_conocio">
                        ...
                        @foreach(App\Models\Usuary::COMO_NOS_CONOCIO_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('como_nos_conocio', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group" id="otros_como_nos_conocio_toggle">
                    <label for="otros_como_nos_conocio">{{ trans('cruds.usuary.fields.otros_como_nos_conocio') }}</label>
                    <input class="form-control {{ $errors->has('otros_como_nos_conocio') ? 'is-invalid' : '' }}" type="text" name="otros_como_nos_conocio" id="otros_como_nos_conocio" value="{{ old('otros_como_nos_conocio', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('derivacion_realizada_por') ? 'is-invalid' : '' }}" onchange="referral_made_toggle(event)" name="derivacion_realizada_por" id="derivacion_realizada_por">
                        ...
                        @foreach(App\Models\Usuary::DERIVACION_REALIZADA_POR_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('derivacion_realizada_por', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group" id="derivacion_realizada_otros_como_nos_conocio_toggle">
                    <label for="otros_derivacion_realizada_por">{{ trans('cruds.usuary.fields.otros_derivacion_realizada_por') }}</label>
                    <input class="form-control {{ $errors->has('otros_derivacion_realizada_por') ? 'is-invalid' : '' }}" type="text" name="otros_derivacion_realizada_por" id="otros_derivacion_realizada_por" value="{{ old('otros_derivacion_realizada_por', '') }}">
            ...
            <div id="socioeconomic" class="tabcontent">
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::SITUACION_LABORAL_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('situacion_laboral') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="situacion_laboral_{{ $key }}" name="situacion_laboral" value="{{ $key }}" {{ old('situacion_laboral', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('prestaciones') ? 'is-invalid' : '' }}" name="prestaciones[]" id="prestaciones" multiple>
                        @foreach(App\Models\Usuary::PRESTACIONES_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('prestaciones', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::DIFICULTADES_ECONOMICAS_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('dificultades_economicas') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="generic_yes_toggle(event, 'dificultades_economicas_si' , 'dificultad_economica_si_toggle')" type="radio" id="dificultades_economicas_{{ $key }}" name="dificultades_economicas" value="{{ $key }}" {{ old('dificultades_economicas', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="dificultad_economica_si_toggle">
                    <label for="dificultad_economica_si">{{ trans('cruds.usuary.fields.dificultad_economica_si') }}</label>
                    <input class="form-control {{ $errors->has('dificultad_economica_si') ? 'is-invalid' : '' }}" type="text" name="dificultad_economica_si" id="dificultad_economica_si" value="{{ old('dificultad_economica_si', '') }}">
            ...
            <div id="sanitary" class="tabcontent">
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::DIAGNOSTICO_SALUD_MENTAL_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('diagnostico_salud_mental') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="generic_yes_toggle(event,'diagnostico_salud_mental_si','otros_diagnostico_salud_toggle')" type="radio" id="diagnostico_salud_mental_{{ $key }}" name="diagnostico_salud_mental" value="{{ $key }}" {{ old('diagnostico_salud_mental', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="otros_diagnostico_salud_toggle">
                    <label for="otros_diagnostico_salud">{{ trans('cruds.usuary.fields.otros_diagnostico_salud') }}</label>
                    <input class="form-control {{ $errors->has('otros_diagnostico_salud') ? 'is-invalid' : '' }}" type="text" name="otros_diagnostico_salud" id="otros_diagnostico_salud" value="{{ old('otros_diagnostico_salud', '') }}">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::TOMA_PSICOFARMACOS_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('toma_psicofarmacos') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="generic_yes_toggle(event,'toma_psicofarmacos_si','otros_toma_psicofarmacos_toggle')" type="radio" id="toma_psicofarmacos_{{ $key }}" name="toma_psicofarmacos" value="{{ $key }}" {{ old('toma_psicofarmacos', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="otros_toma_psicofarmacos_toggle">
                    <label for="otros_toma_psicofarmacos">{{ trans('cruds.usuary.fields.otros_toma_psicofarmacos') }}</label>
                    <input class="form-control {{ $errors->has('otros_toma_psicofarmacos') ? 'is-invalid' : '' }}" type="text" name="otros_toma_psicofarmacos" id="otros_toma_psicofarmacos" value="{{ old('otros_toma_psicofarmacos', '') }}">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::DISCAPACIDAD_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('discapacidad') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="generic_yes_toggle(event, 'discapacidad_si', 'otros_discapacidad_toggle')" type="radio" id="discapacidad_{{ $key }}" name="discapacidad" value="{{ $key }}" {{ old('discapacidad', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="otros_discapacidad_toggle">
                    <label for="otros_discapacidad">{{ trans('cruds.usuary.fields.otros_discapacidad') }}</label>
                    <input class="form-control {{ $errors->has('otros_discapacidad') ? 'is-invalid' : '' }}" type="text" name="otros_discapacidad" id="otros_discapacidad" value="{{ old('otros_discapacidad', '') }}">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::PROBLEMAS_SALUD_FISICA_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('problemas_salud_fisica') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="generic_yes_toggle(event, 'problemas_salud_fisica_si', 'otros_problemas_salud_fisica_toggle')" type="radio" id="problemas_salud_fisica_{{ $key }}" name="problemas_salud_fisica" value="{{ $key }}" {{ old('problemas_salud_fisica', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="otros_problemas_salud_fisica_toggle">
                    <label for="otros_problemas_salud_fisica">{{ trans('cruds.usuary.fields.otros_problemas_salud_fisica') }}</label>
                    <input class="form-control {{ $errors->has('otros_problemas_salud_fisica') ? 'is-invalid' : '' }}" type="text" name="otros_problemas_salud_fisica" id="otros_problemas_salud_fisica" value="{{ old('otros_problemas_salud_fisica', '') }}">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::RELACION_COVID_19_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('relacion_covid_19') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="generic_yes_toggle(event, 'relacion_covid_19_si', 'otros_relacion_covid_19_toggle')" type="radio" id="relacion_covid_19_{{ $key }}" name="relacion_covid_19" value="{{ $key }}" {{ old('relacion_covid_19', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="otros_relacion_covid_19_toggle">
                    <label for="otros_relacion_covid_19">{{ trans('cruds.usuary.fields.otros_relacion_covid_19') }}</label>
                    <input class="form-control {{ $errors->has('otros_relacion_covid_19') ? 'is-invalid' : '' }}" type="text" name="otros_relacion_covid_19" id="otros_relacion_covid_19" value="{{ old('otros_relacion_covid_19', '') }}">
            ...
            <div id="supportNetwork" class="tabcontent">
                <div class="form-group">
                    <label>{{ trans('cruds.usuary.fields.estado_civil') }}</label>
                    <select class="form-control {{ $errors->has('estado_civil') ? 'is-invalid' : '' }}" onchange="other_civil_status(event)" name="estado_civil" id="estado_civil">
                ...
                <div class="form-group" id="estado_civil_otro_toggle">
                    <label for="otros_estado_civil">{{ trans('cruds.usuary.fields.otros_estado_civil') }}</label>
                    <input class="form-control {{ $errors->has('otros_estado_civil') ? 'is-invalid' : '' }}" type="text" name="otros_estado_civil" id="otros_estado_civil" value="{{ old('otros_estado_civil', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('convive_con') ? 'is-invalid' : '' }}" name="convive_con" id="convive_con">
                        ...
                        @foreach(App\Models\Usuary::CONVIVE_CON_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('convive_con', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::VINCULACION_CON_OTROS_RECURSOS_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('vinculacion_con_otros_recursos') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="linkage_with_other_resources_toggle(event)" type="radio" id="vinculacion_con_otros_recursos_{{ $key }}" name="vinculacion_con_otros_recursos" value="{{ $key }}" {{ old('vinculacion_con_otros_recursos', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="si_vinculacion_con_otros_recursos_toggle">
                    <label for="si_vinculacion_con_otros_recursos">{{ trans('cruds.usuary.fields.si_vinculacion_con_otros_recursos') }}</label>
                    <input class="form-control {{ $errors->has('si_vinculacion_con_otros_recursos') ? 'is-invalid' : '' }}" type="text" name="si_vinculacion_con_otros_recursos" id="si_vinculacion_con_otros_recursos" value="{{ old('si_vinculacion_con_otros_recursos', '') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('observaciones') ? 'is-invalid' : '' }}" name="observaciones" id="observaciones">{!! old('observaciones') !!}</textarea>
            ...
            <div id="Housing" class="tabcontent">
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::EN_SITUACION_DE_DESAHUCIO_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('en_situacion_de_desahucio') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="en_situacion_de_desahucio_{{ $key }}" name="en_situacion_de_desahucio" value="{{ $key }}" {{ old('en_situacion_de_desahucio', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('fecha_de_lanzamiento') ? 'is-invalid' : '' }}" type="text" name="fecha_de_lanzamiento" id="fecha_de_lanzamiento" value="{{ old('fecha_de_lanzamiento') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('tipo_de_domicilio') ? 'is-invalid' : '' }}" onchange="type_of_address_toggle(event)" name="tipo_de_domicilio" id="tipo_de_domicilio">
                        ...
                        @foreach(App\Models\Usuary::TIPO_DE_DOMICILIO_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('tipo_de_domicilio', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group" id="otro_tipo_de_domicilio_toggle">
                    <label for="otro_tipo_de_domicilio">{{ trans('cruds.usuary.fields.otro_tipo_de_domicilio') }}</label>
                    <input class="form-control {{ $errors->has('otro_tipo_de_domicilio') ? 'is-invalid' : '' }}" type="text" name="otro_tipo_de_domicilio" id="otro_tipo_de_domicilio" value="{{ old('otro_tipo_de_domicilio', '') }}">
            ...
            <div id="suicidalBehaviorRisk" class="tabcontent">
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('riesgo_conducta_suicida_nivel') ? 'is-invalid' : '' }}" name="riesgo_conducta_suicida_nivel" id="riesgo_conducta_suicida_nivel">
                        ...
                        @foreach(App\Models\Usuary::RIESGO_CONDUCTA_SUICIDA_NIVEL_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('riesgo_conducta_suicida_nivel', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::RIESGO_CONDUCTA_SUICIDA_INTENTOS_PREVIOS_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('riesgo_conducta_suicida_intentos_previos') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="riesgo_conducta_suicida_intentos_previos_{{ $key }}" name="riesgo_conducta_suicida_intentos_previos" value="{{ $key }}" {{ old('riesgo_conducta_suicida_intentos_previos', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('riesgo_conducta_suicida_ultima_fecha') ? 'is-invalid' : '' }}" type="text" name="riesgo_conducta_suicida_ultima_fecha" id="riesgo_conducta_suicida_ultima_fecha" value="{{ old('riesgo_conducta_suicida_ultima_fecha') }}">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::RIESGO_CONDUCTA_SUICIDA_PLANIFICACION_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('riesgo_conducta_suicida_planificacion') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="planning_for_suicidal_behavior_toggle(event)" type="radio" id="riesgo_conducta_suicida_planificacion_{{ $key }}" name="riesgo_conducta_suicida_planificacion" value="{{ $key }}" {{ old('riesgo_conducta_suicida_planificacion', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="si_planificacion_toggle">
                    <label for="si_planificacion">{{ trans('cruds.usuary.fields.si_planificacion') }}</label>
                    <input class="form-control {{ $errors->has('si_planificacion') ? 'is-invalid' : '' }}" type="text" name="si_planificacion" id="si_planificacion" value="{{ old('si_planificacion', '') }}">
            ...
            <div id="genderViolence" class="tabcontent">
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('tipo_violencia_sufrida') ? 'is-invalid' : '' }}" name="tipo_violencia_sufrida" id="tipo_violencia_sufrida">
                        ...
                        @foreach(App\Models\Usuary::TIPO_VIOLENCIA_SUFRIDA_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('tipo_violencia_sufrida', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::CONVIVE_CON_EL_AGRESOR_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('convive_con_el_agresor') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="convive_con_el_agresor_{{ $key }}" name="convive_con_el_agresor" value="{{ $key }}" {{ old('convive_con_el_agresor', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::RECIBE_O_HA_RECIBIDO_ATENCION_PSICOSOCIAL_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('recibe_o_ha_recibido_atencion_psicosocial') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="psychological_care_toggle(event)" type="radio" id="recibe_o_ha_recibido_atencion_psicosocial_{{ $key }}" name="recibe_o_ha_recibido_atencion_psicosocial" value="{{ $key }}" {{ old('recibe_o_ha_recibido_atencion_psicosocial', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="si_recibe_o_ha_recibido_atencion_psicosocial_toggle">
                    ...
                    <input class="form-control {{ $errors->has('si_recibe_o_ha_recibido_atencion_psicosocial') ? 'is-invalid' : '' }}" type="text" name="si_recibe_o_ha_recibido_atencion_psicosocial" id="si_recibe_o_ha_recibido_atencion_psicosocial" value="{{ old('si_recibe_o_ha_recibido_atencion_psicosocial', '') }}">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Usuary::OTROS_TIPOS_DE_VIOLENCIA_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('otros_tipos_de_violencia') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" onclick="other_types_violence_toggle(event)" type="radio" id="otros_tipos_de_violencia_{{ $key }}" name="otros_tipos_de_violencia" value="{{ $key }}" {{ old('otros_tipos_de_violencia', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group" id="si_otros_tipos_de_violencia_toggle">
                    <label for="si_otros_tipos_de_violencia">{{ trans('cruds.usuary.fields.si_otros_tipos_de_violencia') }}</label>
                    <input class="form-control {{ $errors->has('si_otros_tipos_de_violencia') ? 'is-invalid' : '' }}" type="text" name="si_otros_tipos_de_violencia" id="si_otros_tipos_de_violencia" value="{{ old('si_otros_tipos_de_violencia', '') }}">
            ...
            <div id="alta" class="tabcontent">
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('motivo_de_alta') ? 'is-invalid' : '' }}" name="motivo_de_alta" id="motivo_de_alta">{!! old('motivo_de_alta') !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('fecha_alta') ? 'is-invalid' : '' }}" type="text" name="fecha_alta" id="fecha_alta" value="{{ old('fecha_alta') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('derivacion_a') ? 'is-invalid' : '' }}" onchange="alta_other_referral_toggle()" name="derivacion_a" id="derivacion_a">
                        ...
                        @foreach(App\Models\Usuary::DERIVACION_A_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('derivacion_a', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group" id="alta_otros_derivacion_a_toggle">
                    <label for="otros_derivacion_a">{{ trans('cruds.usuary.fields.otros_derivacion_a') }}</label>
                    <input class="form-control {{ $errors->has('otros_derivacion_a') ? 'is-invalid' : '' }}" type="text" name="otros_derivacion_a" id="otros_derivacion_a" value="{{ old('otros_derivacion_a', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::DOCUMENTACION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('documentacion') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="documentacion_{{ $key }}" name="documentacion" value="{{ $key }}" {{ old('documentacion', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="documentacion_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('documentacion'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::DIFICULTADES_ECONOMICAS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dificultades_economicas') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dificultades_economicas_{{ $key }}" name="dificultades_economicas" value="{{ $key }}" {{ old('dificultades_economicas', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="dificultades_economicas_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('dificultades_economicas'))
            ...
            {{-- <div class="form-group">
                ...
                @foreach(App\Models\Usuary::DIAGNOSTICO_SALUD_MENTAL_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('diagnostico_salud_mental') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="diagnostico_salud_mental_{{ $key }}" name="diagnostico_salud_mental" value="{{ $key }}" {{ old('diagnostico_salud_mental', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="diagnostico_salud_mental_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('diagnostico_salud_mental'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::TOMA_PSICOFARMACOS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('toma_psicofarmacos') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="toma_psicofarmacos_{{ $key }}" name="toma_psicofarmacos" value="{{ $key }}" {{ old('toma_psicofarmacos', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="toma_psicofarmacos_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('toma_psicofarmacos'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::DISCAPACIDAD_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('discapacidad') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="discapacidad_{{ $key }}" name="discapacidad" value="{{ $key }}" {{ old('discapacidad', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="discapacidad_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('discapacidad'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::PROBLEMAS_SALUD_FISICA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('problemas_salud_fisica') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="problemas_salud_fisica_{{ $key }}" name="problemas_salud_fisica" value="{{ $key }}" {{ old('problemas_salud_fisica', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="problemas_salud_fisica_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('problemas_salud_fisica'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::RELACION_COVID_19_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('relacion_covid_19') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="relacion_covid_19_{{ $key }}" name="relacion_covid_19" value="{{ $key }}" {{ old('relacion_covid_19', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="relacion_covid_19_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('relacion_covid_19'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::VINCULACION_CON_OTROS_RECURSOS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('vinculacion_con_otros_recursos') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="vinculacion_con_otros_recursos_{{ $key }}" name="vinculacion_con_otros_recursos" value="{{ $key }}" {{ old('vinculacion_con_otros_recursos', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="vinculacion_con_otros_recursos_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('vinculacion_con_otros_recursos'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::RIESGO_CONDUCTA_SUICIDA_PLANIFICACION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('riesgo_conducta_suicida_planificacion') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="riesgo_conducta_suicida_planificacion_{{ $key }}" name="riesgo_conducta_suicida_planificacion" value="{{ $key }}" {{ old('riesgo_conducta_suicida_planificacion', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="riesgo_conducta_suicida_planificacion_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('riesgo_conducta_suicida_planificacion'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::RECIBE_O_HA_RECIBIDO_ATENCION_PSICOSOCIAL_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('recibe_o_ha_recibido_atencion_psicosocial') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="recibe_o_ha_recibido_atencion_psicosocial_{{ $key }}" name="recibe_o_ha_recibido_atencion_psicosocial" value="{{ $key }}" {{ old('recibe_o_ha_recibido_atencion_psicosocial', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="recibe_o_ha_recibido_atencion_psicosocial_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('recibe_o_ha_recibido_atencion_psicosocial'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Usuary::OTROS_TIPOS_DE_VIOLENCIA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('otros_tipos_de_violencia') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="otros_tipos_de_violencia_{{ $key }}" name="otros_tipos_de_violencia" value="{{ $key }}" {{ old('otros_tipos_de_violencia', '') === (string) $key ? 'checked' : '' }}>
                        <label class="form-check-label" for="otros_tipos_de_violencia_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
                @if($errors->has('otros_tipos_de_violencia'))
